...
2. Choose a Debrid service for caching the torrents, create an account on it, buy a subscription, and get the API key.
   ...
   * *I use mainly* [***TorBox***](https://torbox.app/subscription?referral=8000643c-a825-4e7b-a33d-1282f76791f1), as a backup I use [***Real-Debrid***](http://real-debrid.com/?id=12639093) *(these are referral links since we're at it :), two of the best platforms, with the best prices and very stable.*
