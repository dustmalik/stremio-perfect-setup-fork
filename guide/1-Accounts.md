...
5. Choose a Debrid service for caching the torrents, create an account on it, buy a subscription, and get the API key.
   ...
   * *I use mainly* [***TorBox***](https://torbox.app/subscription?referral=6e80077e-c232-4b71-8914-5b87202b9577), as a backup I use [***Real-Debrid***](http://real-debrid.com/?id=8801126) *(these are referral links since we're at it :), two of the best platforms, with the best prices and very stable.* **DON'T USE REAL-DEBRID FOR NOW, IT'S HAVING LEGAL ISSUES, PROCEED WITH TORBOX.**
